![banner](https://i.ibb.co/yFbB78J/photo-2024-10-11-19-38-23.jpg)

[![Static Badge](https://img.shields.io/badge/Telegram-Bot%20Link-Link?style=for-the-badge&logo=Telegram&logoColor=white&logoSize=auto&color=blue)](https://t.me/major/start?startapp=1178697351)
...
## Recommendation before use Major Script
...
| Auto Hold Coins  					                       |     ✅     |
| Auto Swipe Coins                   				       |     ✅     |
| Auto Puzzle Pavel (edit answers.json)                        				   |     ✅     |
|                  Auto Daily Streak                       |     ✅     |
...
## Installation
You can download the [**repository**](https://github.com/outputman/MajorBot) by cloning it to your system and installing the necessary dependencies:
```shell
git clone https://github.com/outputman/MajorBot.git
cd MajorBot
```
